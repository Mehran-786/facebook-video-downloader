...
const translations = {
    ...
    "ja": { 
        "processBtn": "ダウンロード", "contactBtn": '<i class="fas fa-envelope"></i> 連絡する', "langBtn": "言語", "extBtn": '<i class="fas fa-puzzle-piece"></i> 拡張機能 <span style="font-size: 10px; background: red; padding: 2px 5px; border-radius: 5px; margin-left: 10px;">まもなく</span>', "mainTitle": "動画ダウンローダー", "tagline": "高品質な動画を簡単にダウンロード", "placeholder": "ここに動画のリンクを貼り付けてください...", "f1Title": "高速ダウンロード", "f1Desc": "数秒で動画を取得", "f2Title": "安心・安全", "f2Desc": "ログイン不要、追跡なし", "f3Title": "オールインワンHD", 
        "f3Desc": "Facebook 動画ダウンローダー<br>Instagram 動画ダウンローダー<br>Threads 動画ダウンローダー",
    ...
    "it": { 
        ...
        "f3Desc": "Scaricatore di video Facebook<br>Scaricatore di video Instagram<br>Scaricatore di video Threads",
